...
pub trait ReadTransaction {
    fn cursor<'c, 'a, A : Allocator<'a>>(&'c self, allocator: &mut A) -> Result<Cursor<'a, A> + 'c, Error>;
...
pub trait Cursor<'a, A : Allocator<'a>> {
    ...
    fn current_key(&mut self, allocator: &mut A) -> Option<&'a [u8]>;
    fn current_value(&mut self, allocator: &mut A) -> Option<&'a [u8]>;
}
